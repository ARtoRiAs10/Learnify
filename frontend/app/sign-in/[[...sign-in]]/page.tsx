 ...
 *
 * Clerk reads NEXT_PUBLIC_CLERK_SIGN_IN_URL=/sign-in and navigates
 * here after authentication flows. Without this file Next.js 404s.
 */
    ...
    <div className="min-h-screen mesh-bg flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Welcome back — sign in to continue learning</p>
        </div>
        <SignIn
          appearance={{
            elements: {
